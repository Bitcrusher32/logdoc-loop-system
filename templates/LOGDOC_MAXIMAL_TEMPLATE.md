...
Before using this template, delete or modify any sections your project does not need. This template is not more rigorous than the minimal template. It is only more exhaustive. Adherence to proper LogDoc hygiene, update cadence, and systems fundamentals will produce significantly higher quality LogDocs than excessively verbose LogDocs.
...
### 4.1 High-Risk Actions To Avoid
...
### 6.1 Minimum Validation

- [ ]

### 6.2 Intermediate Validation
...
### 6.5 Claims Allowed After Current Validation
